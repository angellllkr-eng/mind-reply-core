...
## Physical human actions (only when required)
Signing, physical meetings, deliveries, in-person communication — only when no digital path exists AND the outcome is positive. Then produce one clean Owner Action Packet.
